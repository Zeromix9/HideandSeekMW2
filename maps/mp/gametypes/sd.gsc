...
bombs()
{
	...
	visuals[0] setModel( "" ); //prop_suitcase_bomb removed
	...
	for ( index = 0; index < bombZones.size; index++ )
	{
		...
		*/
		...
		bombZone.onUse = ::onCantUse;        //onUsePlantObject;
...
onCantUse( player )
{
	player iPrintLnBold("^1Kill the hiders you BITCH!");
}
...
bombPlanted( destroyedObj, player )
{
	...
	else
	{
		...
		level.sdBombModel setModel( "" ); //prop_suitcase_bomb removed
	}
